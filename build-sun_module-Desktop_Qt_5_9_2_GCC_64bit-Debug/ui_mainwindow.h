...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(380, 40, 230, 70));
        ...
        layoutWidget1->setGeometry(QRect(80, 40, 281, 70));
        ...
        lineEdit_test->setGeometry(QRect(380, 120, 113, 25));
        label_time = new QLabel(centralWidget);
        label_time->setObjectName(QStringLiteral("label_time"));
        label_time->setGeometry(QRect(460, 10, 241, 20));
